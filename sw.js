...
const CACHE_VERSION = 'v20260616-011832';
...
const PRECACHE = [
  ...
  '/js/components/financeProjecao.js',
  '/js/components/financeRelatorios.js',
  '/js/components/financePossoGastar.js',
  '/js/components/financeAlertas.js',
  '/js/components/financeReview.js',
  '/js/components/financeRegua.js',
  '/js/components/financeImport.js',
  '/js/components/financeCarteiras.js',
  '/js/components/financeCategorias.js',
  '/js/components/financeMetas.js',
